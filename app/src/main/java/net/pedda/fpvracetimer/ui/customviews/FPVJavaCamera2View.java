package net.pedda.fpvracetimer.ui.customviews;
...
@TargetApi(21)
public class FPVJavaCamera2View extends CameraBridgeViewBase {
    ...
    protected Range<Long> mExposureRange;
    protected Range<Integer> mSensitivityRange;
    ...
    public FPVJavaCamera2View(Context context, int cameraId) {
        super(context, cameraId);
    }

    public FPVJavaCamera2View(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
//                    mPreviewRequestBuilder.set(CaptureRequest.COLOR_CORRECTION_MODE, );
    ...
    public void setExposure(long value) {
        ...
        try {
            ...
            Log.e(TAG, "setExposure: CAE caught");
        }
    }
    ...
    public void setSensitivity(int value) {
        ...
        int sensitivity = mPreviewRequestBuilder.get(CaptureRequest.SENSOR_SENSITIVITY);
        mPreviewRequestBuilder.set(CaptureRequest.SENSOR_SENSITIVITY, value);
        try {
            mCaptureSession.setRepeatingRequest(mPreviewRequestBuilder.build(), null, mBackgroundHandler);
        } catch (CameraAccessException cae) {
            Log.e(TAG, "setSensitivity: CAE caught");
        }
    }
    ...
    public int getSensitivity() {
        return mSensitivity; //TODO Make this do something
    }
}
